    ...
    public void discoverDevices() {
        ...
        manager.discoverPeers(channel, new WifiP2pManager.ActionListener() {
            ...
            public void onSuccess() {
                Toast.makeText(SpeakerActivity.this, "탐색 초기화", Toast.LENGTH_SHORT).show();
                Log.d(TAG, "탐색초기화.");
            }
            ...
            public void onFailure(int reasonCode) {
                Log.e(TAG, "탐색실패. Error Code is: " + reasonCode);
                manager.stopPeerDiscovery(channel, new WifiP2pManager.ActionListener() {
                    @Override
                    public void onFailure(int reason) {
                        Log.e(TAG, "탐색 중단 실패. Error Code is: " + reason);
                    }
                    ...
                    public void onSuccess() {
                        manager.discoverPeers(channel, new WifiP2pManager.ActionListener() {
                            @Override
                            public void onSuccess() {
                                Toast.makeText(SpeakerActivity.this, "Music Player 탐색중",
                            ...
                            @Override
                            public void onFailure(int reasonCode) {
                                Log.e(TAG, "탐색 실패. Error Code is: " + reasonCode);
                            }
                        });
                    }
                });
