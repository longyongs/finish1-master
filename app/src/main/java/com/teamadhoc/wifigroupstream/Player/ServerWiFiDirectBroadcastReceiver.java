...
public class ServerWiFiDirectBroadcastReceiver extends BroadcastReceiver{
    ...
    private com.teamadhoc.wifigroupstream.Player.PlayerActivity activity;

    public ServerWiFiDirectBroadcastReceiver(WifiP2pManager manager, WifiP2pManager.Channel channel,
                                             com.teamadhoc.wifigroupstream.Player.PlayerActivity activity) {
        super();
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (WifiP2pManager.WIFI_P2P_STATE_CHANGED_ACTION.equals(action)) {
            ...
            if (networkInfo.isConnected()) {
                ...
                com.teamadhoc.wifigroupstream.Player.ServerDeviceListFragment fragment = (com.teamadhoc.wifigroupstream.Player.ServerDeviceListFragment) activity
                        .getFragmentManager().findFragmentById(R.id.frag_Player_devices);
            ...
            com.teamadhoc.wifigroupstream.Player.ServerDeviceListFragment fragment = (com.teamadhoc.wifigroupstream.Player.ServerDeviceListFragment) activity.getFragmentManager()
                    .findFragmentById(R.id.frag_Player_devices);
